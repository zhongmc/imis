...
-- ----------------------------
INSERT INTO department (id, name, parent_id, full_id) values(1,'易诚互动', null, '.1');
INSERT INTO department (id, name, parent_id, full_id) values(2, '运营管理部', 1, '.1.2');
INSERT INTO department (id, name, parent_id, full_id) values(21,'财务部', 2, '.1.2.21');
INSERT INTO department (id, name, parent_id, full_id) values(22,'项目管理部',2,'.1.2.22');
INSERT INTO department (id, name, parent_id, full_id) values(23,'人力资源部',2,'.1.2.23');
INSERT INTO department (id, name, parent_id, full_id) values(3,'北部大区', 1, '.1.3');
INSERT INTO department (id, name, parent_id, full_id) values(31,'北一部',3, '.1.3.31');
INSERT INTO department (id, name, parent_id, full_id) values(32,'北二部',3, '.1.3.32');
INSERT INTO department (id, name, parent_id, full_id) values(33,'北三部',3, '.1.3.33');
INSERT INTO department (id, name, parent_id, full_id) values(4,'东部大区',1, '.1.4');
INSERT INTO department (id, name, parent_id, full_id) values(41,'东一部',4, '.1.4.41');
INSERT INTO department (id, name, parent_id, full_id) values(42, '东二部',4, '.1.4.42');
INSERT INTO department (id, name, parent_id, full_id) values(43, '东三部',4, '.1.4.43');
INSERT INTO department (id, name, parent_id, full_id) values(5, '南部大区', 1,'.1.5');
INSERT INTO department (id, name, parent_id, full_id) values(51, '南一部', 5, '.1.5.51');
INSERT INTO department (id, name, parent_id, full_id) values(52, '南二部', 5, '.1.5.52');
INSERT INTO department (id, name, parent_id, full_id) values(53, '南三部', 5, '.1.5.53' );




insert into menu (id, parent_id, name, url, path, component, hidden) values (2, null, '项目管理', '/', '/home', 'pages/Home.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (21, 2, '项目基础信息', '/project/basic/**', '/prj/basic', 'components/project/PrjBasic.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (22, 2, '项目预算', '/project/budget/**', '/prj/budget/:id', 'components/project/PrjBudget.vue', 1);
insert into menu (id, parent_id, name, url, path, component, hidden) values (23, 2, '项目机会', 'project/chance/**', '/prj/chance', 'components/project/PrjCHance.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (3, null, '客户管理', '/', '/home', 'pages/Home.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (31, 3, '客户基础信息', '/custom/basic/**', '/custom/basic', 'components/custom/CustomMana.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (32, 3, '客户干系人', '/custom/contactor/**', '/custom/contactor', 'components/custom/CustomContactor.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (33, 3, '客户跟踪', '/custom/trace/**', '/custom/trace', 'components/custom/CustomTrace.vue',0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (4, null, '部门预算', '/', '/home', 'pages/Home.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (41, 4, '部门预算', '/budget/basic/**', '/budget/basic', 'components/budget/BudgetBasic.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (42, 4, '部门预算汇总', '/budget/collect/**', '/budget/collect', 'components/budget/BudgetCollect.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (5, null, '系统设置', '/', '/home', 'pages/Home.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (51, 5, '基础信息设置', '/system/basic/**', '/sys/basic', 'components/system/SysBasic.vue', 0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (52, 5, '预算设置', '/system/budget/**', '/sys/budget', 'components/system/SysBudget.vue',0);
insert into menu (id, parent_id, name, url, path, component, hidden) values (53, 5, '操作员管理', '/system/user/**', '/sys/user', 'components/system/SysUser.vue',0);

insert into ynb_user(id, dep_id, user_name, nick_name, password, first_password, is_password_change, supervisor, status) values(1, 1, 'admin', '系统管理员', '$2a$10$ySG2lkvjFHY5O0./CPIE1OI8VJsuKYEzOYzqIa7AJR6sEgSzUFOAm','$2a$10$ySG2lkvjFHY5O0./CPIE1OI8VJsuKYEzOYzqIa7AJR6sEgSzUFOAm', 1, 1, 'ACTIVE');
insert into role(id, name, name_zh) values(1, 'ROLE_admin', '系统管理员');

insert into role_menu(id, menu_id, role_id) values(1, 5, 1);
insert into role_menu(id, menu_id, role_id) values(2, 51, 1);
insert into role_menu(id, menu_id, role_id) values(3, 52, 1);
insert into role_menu(id, menu_id, role_id) values(4, 53, 1);
