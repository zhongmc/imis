    ...
    <el-container>
      <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
        <div style="display: inline">
          ...
          <el-button type="primary" size="mini" style="margin-left: 5px" icon="el-icon-search" @click="searchPrj">搜索
          </el-button>
			...
			<el-form :inline="true" :model="advSearchData">
              ...
              <el-row>
                <el-col :span="6">
                  ...
                  <el-select v-model="advSearchData.customId" style="width: 130px" size="mini" placeholder="请选择所属客户">
                    <el-option
                ...
                <el-col :span="7">
                  <el-form-item label="项目类型:" >
                   <el-select v-model="advSearchData.prjTypeId" style="width: 130px" size="mini" placeholder="请选择项目类型">
                    <el-option
              ...
              <el-row style="margin-top: 10px">
                <el-col :span="6">
                  ...
                  <el-popover
                    ...
                    <div slot="reference"
                         ...
                         @click="showDepTree2" v-bind:style="{color: depTextColor}">{{advSearchData.departmentName}}
                    </div>
                  </el-popover>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="5" :offset="2">
                  ...
                  <el-button icon="el-icon-search" type="primary" size="mini" @click="searchPrj">搜索</el-button>
                </el-col>
              </el-row>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button type="danger" style="padding: 3px 4px 3px 4px;margin: 2px" size="mini"
                           @click="deletePrj(scope.row)">删除
                </el-button>
              </template>
            </el-table-column>
          </el-table>
          <div style="display: flex;justify-content: space-between;margin: 2px">
            <el-button type="danger" size="mini" v-if="prjs.length>0" :disabled="multipleSelection.length==0"
                       @click="deleteManyPrjs">批量删除
            </el-button>
            <el-pagination
              background
              :page-size="10"
          ...
          <el-row>
            <el-col :span="10">
                <el-form-item label="项目名称:" prop="name">
                  <el-input  v-model="prj.name" size="mini" style="width: 250px"
                            placeholder="请输入项目名称"></el-input>
                </el-form-item>
            </el-col>
            <el-col :span="8">
                <el-form-item label="项目编号:" prop="projectNo">
                  <el-input  v-model="prj.projectNo" size="mini" style="width: 150px"
              ...
              <el-row>
                <el-col :span="6">
                  ...
                  <el-select v-model="prj.customId" style="width: 130px" size="mini" placeholder="请选择所属客户">
                    <el-option
                      v-for="item in customs"
                      :key="item.id"
                      :label="item.name"
                ...
                <el-col :span="7">
                  <el-form-item label="项目类型:" >
                   <el-select v-model="prj.prjTypeId" style="width: 130px" size="mini" placeholder="请选择项目类型">
                    <el-option
                      v-for="item in prjTypes"
                      :key="item.id"
                      :label="item.name"
                ...
                <el-col :span="10">
                  ...
                  <el-popover
                    ...
                    <div slot="reference"
                         ...
                         @click="showDepTree" v-bind:style="{color: depTextColor}">{{prj.departmentName}}
                    </div>
                  </el-popover>
                  </el-form-item>
                </el-col>
  ...
  export default {
    data() {
      return {
        ...
        prjTypes:[{id: -1, name: '请选择项目类型'},  {id: 1, name: '派单类'}, {id: 2, name: '实施类'}, {id: 3, name: '人月类'}],
        customs:[{id:-1, name:'请选择所属客户'}, {id:1, name:'交通银行'},{id:2, name:'广东发展银行'}],
        ...
        rules: {
          ...
          projectNo: [{required: true, message: '必填:项目编号', trigger: 'blur'}],
          departmentId: [{required: true, message: '必填:所属部门', trigger: 'change'}],
          customId: [{required: true, message: '必填:所属客户', trigger: 'change'}],
          beginDate: [{required: true, message: '必填:启动日期', trigger: 'blur'}],
