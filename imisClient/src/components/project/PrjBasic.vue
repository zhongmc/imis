<template>
  <div>
              ...
              <el-row>
                <el-col :span="10">
                 ...
                 <el-popover
                    ...
                    title="请选择所属客户"
                    trigger="manual">
                    <el-tree :data="customTreeData" :default-expand-all="true" :props="defaultProps" :expand-on-click-node="false"
                             @node-click="handleCustomTreeNodeClick2"></el-tree>
                    <div slot="reference"
                         ...
                         @click="showCustomTree2" v-bind:style="{color: depTextColor}">{{advSearchData.customName}}
                    </div>
                  </el-popover>
              ...
              <el-row >
                ...
                <el-col :span="7">
                  <el-form-item label="项目类型:" >
                   <el-select v-model="advSearchData.prjType" style="width: 130px" size="mini" placeholder="请选择项目类型">
                    <el-option
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button @click="showEditPrjBudgetView(scope.row)" 
                    style="padding: 3px 4px 3px 4px;margin: 2px" type="primary"
                           size="mini">项目预算
                </el-button>
          ...
          <el-row>
            ...
            <el-col :span="8">
                <el-form-item label="项目编号:" prop="prjNo">
                  <el-input  v-model="prj.prjNo" size="mini" style="width: 150px"
              ...
              <el-row>
                <el-col :span="10">
                 ...
                 <el-popover
                    ...
                    trigger="manual">
                    <el-tree :data="customTreeData" :default-expand-all="true" :props="defaultProps" :expand-on-click-node="false"
                             @node-click="handleCustomTreeNodeClick"></el-tree>
                    <div slot="reference"
                         style="width: 230px;height: 26px;display: inline-flex;font-size:13px;border: 1px;border-radius: 5px;border-style: solid;padding-left: 13px;box-sizing:border-box;border-color: #dcdfe6;cursor: pointer;align-items: center"
                         @click="showCustomTree" v-bind:style="{color: depTextColor}">{{prj.customName}}
                    </div>
                  </el-popover>
               </el-form-item>
                </el-col>
              ...
              <el-row style="margin-top: 10px">
                ...
                <el-col :span="7">
                  <el-form-item label="项目类型:" >
                   <el-select v-model="prj.prjType" style="width: 130px" size="mini" placeholder="请选择项目类型">
                    <el-option
                      v-for="item in prjTypes"
                      :key="item.id"
                      :label="item.name"
    ...
    </el-form> <!-- end prj edit/add form dialog -->
