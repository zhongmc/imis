    ...
    <el-container>
      ...
      <el-tabs  type="card" v-model="activeTab">
        ...
        <el-tab-pane label="收款" name="income">
          <common-item type="income" name="收款" v-bind:prjid = "this.curPrjId" v-bind:depid = "this.depId"></common-item>
        </el-tab-pane>
        <el-tab-pane label="确权" name="rights">
          <common-item type="confirm"  name="确权" v-bind:prjid = "this.curPrjId" v-bind:depid = "this.depId"></common-item>
        </el-tab-pane>
