   ...
   data(){
    ...
    methods: {
      toggleMenu(){
        ...
        menuShow = !menuShow;        
        if(menuShow)
          this.showMenuClass = 'nav-content showNav';
        else
          this.showMenuClass = 'nav-content hideNav';
...
.menuButton:hover{text-decoration:none;}


.menuButton a{display:block;width:40px; height:40px;padding:0;
  margin-top:1px;
  line-height:12px;text-align:center;color:#787878;text-decoration:none;
  background: url(../assets/scrolltop.png) no-repeat 0 3px;
 
}

.menuButton a:hover{background:#759fd9 url(../assets/scrolltop.png) no-repeat 0 3px; background-position:-40px 3px !important;}

.menuButton a.menuList{background-position:0 -72px !important;}
.menuButton a.menuList:hover{background-position:-40px -72px !important;}
